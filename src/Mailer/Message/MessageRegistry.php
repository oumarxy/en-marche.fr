...
class MessageRegistry
{
    private $types = [
        ...
        CitizenInitiativeAdherentsNearMessage::class => 'citizen_initiative_adherent_near',
        ...
        CitizenInitiativeNearSupervisorsMessage::class => 'citizen_initiative_near_supervisor',
